...
import io.legado.read.databinding.ItemBookFileImportBinding
...
import io.legado.read.utils.openFileUri
...
class ImportOnLineBookFileDialog : BaseDialogFragment(R.layout.dialog_recycler_view) {
    ...
    inner class BookFileAdapter(context: Context) :
        RecyclerAdapter<Triple<String, String, Boolean>, ItemBookFileImportBinding>(context) {
