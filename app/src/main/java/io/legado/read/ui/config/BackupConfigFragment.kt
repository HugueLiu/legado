...
import io.legado.read.help.storage.BackupConfig
import io.legado.read.help.storage.ImportOldData
import io.legado.read.help.storage.Restore
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<io.legado.read.lib.prefs.Preference>("web_dav_restore")
